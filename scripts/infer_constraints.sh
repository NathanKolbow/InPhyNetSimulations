...
if [[ "${imethod}" == "snaq" ]]; then
    ...
    julia -t2 -p2 "${scriptdir}/subscripts/infer_snaq.jl" "${basedir}/subsets" "${basedir}/estgts.tre" "${basedir}/snaq.net" "${basedir}/snaq.runtime" "${basedir}/true.net" "${basedir}/temp-data/" "${seed}"
fi
