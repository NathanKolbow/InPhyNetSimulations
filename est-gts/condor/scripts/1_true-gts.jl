...
function sim_true_gts(ntaxa::Int64, rep::Int64, ils::String, ngt::Int64, m::Int64)
    ...
    output_file_prefix = "/mnt/dv/wid/projects4/SolisLemus-network-merging/InPhyNet-Simulations/est-gts/data/true-gts/"
    output_file_prefix *= "n$(ntaxa)-r$(rep)-$(ils)-$(ngt)gt-m$(m).treefile"
    ...
    for i = 1:ngt
        writeTopology(gts[i], output_file_prefix*"_$(i)")
    end
end
